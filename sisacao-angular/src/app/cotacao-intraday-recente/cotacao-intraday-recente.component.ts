...
import { CotacaoIntradayAcao, CotacaoIntradayAcaoApi, CotacaoIntradayFoxbit, CotacaoIntradayFoxbitApi, CotacaoIntradayImobiliario, CotacaoIntradayImobiliarioApi, CotacaoIntradayIndice, CotacaoIntradayIndiceApi, CotacaoIntradayMercadoBitcoin, CotacaoIntradayMercadoBitcoinApi } from '../shared/sdk';
...
export class CotacaoIntradayRecenteComponent implements OnInit {
  ...
  carregaIntra() {
    ...
    this.srvImobiliario.find(filtro)
      .subscribe((result: CotacaoIntradayImobiliario[]) => {
        console.log('ListaMercadoBitcoin: ', result)
        this.listaImobiliario = result;
      })
  }
}
