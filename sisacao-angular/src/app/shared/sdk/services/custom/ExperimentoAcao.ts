...
/**
 * Api services for the `ExperimentoAcao` model.
 */
@Injectable()
export class ExperimentoAcaoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ExperimentoAcao id
   *
