...
/**
 * Api services for the `MovimentacaoValorAplicado` model.
 */
@Injectable()
export class MovimentacaoValorAplicadoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id MovimentacaoValorAplicado id
   *
  ...
  public getTipoAplicacao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/MovimentacaoValorAplicados/:id/tipoAplicacao";
  ...
  public getInstituicaoFinanceira(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MovimentacaoValorAplicados/:id/instituicaoFinanceira";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
