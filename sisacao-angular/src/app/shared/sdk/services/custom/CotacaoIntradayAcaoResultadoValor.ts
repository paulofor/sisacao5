...
export class CotacaoIntradayAcaoResultadoValorApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public TempoMedioTickerPorRegraData(idRegra: any = {}, diaNum: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultadoValors/tempoMedioTickerPorRegraData";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idRegra !== 'undefined' && idRegra !== null) _urlParams.idRegra = idRegra;
