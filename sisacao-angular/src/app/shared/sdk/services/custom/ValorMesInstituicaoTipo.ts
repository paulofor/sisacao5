...
/**
 * Api services for the `ValorMesInstituicaoTipo` model.
 */
@Injectable()
export class ValorMesInstituicaoTipoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ValorMesInstituicaoTipo id
   *
   ...
   * This usually means the response is a `ValorMesInstituicaoTipo` object.)
   * </em>
   */
  public getTipoAplicacao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ValorMesInstituicaoTipos/:id/tipoAplicacao";
  ...
  public getInstituicaoFinanceira(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ValorMesInstituicaoTipos/:id/instituicaoFinanceira";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public TotaisMesCorrente(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ValorMesInstituicaoTipos/totaisMesCorrente";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
