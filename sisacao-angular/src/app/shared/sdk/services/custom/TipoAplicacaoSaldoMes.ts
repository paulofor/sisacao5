...
/**
 * Api services for the `TipoAplicacaoSaldoMes` model.
 */
@Injectable()
export class TipoAplicacaoSaldoMesApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id TipoAplicacaoSaldoMes id
   *
  ...
  public getTipoAplicacao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/TipoAplicacaoSaldoMes/:id/tipoAplicacao";
   ...
   * </em>
   */
  public CalculaProjecao(tipoAplicacaoId: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TipoAplicacaoSaldoMes/calculaProjecao";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
