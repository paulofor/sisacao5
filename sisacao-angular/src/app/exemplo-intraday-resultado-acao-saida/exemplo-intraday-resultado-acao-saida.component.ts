...
import { CotacaoIntradayAcaoResultado, CotacaoDiarioAcao, RegraProjecao, ExemploTreinoAcaoSaidaApi, CotacaoIntradayAcaoResultadoApi, CotacaoDiarioAcaoApi, RegraProjecaoApi, ExemploTreinoAcao } from '../shared/sdk';

@Component({
  selector: 'app-exemplo-intraday-resultado-acao-saida',
  templateUrl: './exemplo-intraday-resultado-acao-saida.component.html',
  styleUrls: ['./exemplo-intraday-resultado-acao-saida.component.css']
})
export class ExemploIntradayResultadoAcaoSaidaComponent implements OnInit {
  ...
  tamanhoCampoX : number;
  tamanhoCampoXOriginal: number;
  diasCampoX : number;

  listaRegra: RegraProjecao[];

  constructor(private srv :ExemploTreinoAcaoSaidaApi, 
  ...
  carregaExemplo() {
    ...
    this.srv.ObtemComEntrada(this.ticker,this.data,this.regraProjecaoId)
      .subscribe((result:ExemploTreinoAcao[]) => {
        ...
        this.tamanhoCampoX = this.listaValor.length;
        this.listaValorOriginal = this.exemplo.campoXOriginal.split(',');
        this.tamanhoCampoXOriginal = this.listaValorOriginal.length;
