...
export class TradeAtivoComponent extends BaseListComponent {
  ...
  carregaTela() {
    this.srv.ListaAbertoComPrecoStop()
    .subscribe((result:any[]) => {
        console.log('resultStop: ' , result);
        this.listaStop = result;
        //this.posCarregaLista();
        
    })
    this.srv.ListaAbertoComPrecoTarget()
    .subscribe((result:any[]) => {
        console.log('resultTarget: ' , result);
        this.listaTarget = result;
        //this.posCarregaLista();
