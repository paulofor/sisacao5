...
export class ExperimentoRedeNeuralListBaseComponent implements OnInit {
	principal: ExperimentoRedeNeural;
	listaBase:ExperimentoRedeNeural[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:ExperimentoRedeNeural[]) => {
	...
	getComponente() : any {
		return ExperimentoRedeNeuralEditComponent
	}
