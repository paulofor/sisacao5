...
export class AtivoIndiceApi extends BaseLoopBackApi {
  ...
  public findByIdCotacaoIntradayIndiceResultados(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/AtivoIndices/:id/cotacaoIntradayIndiceResultados/:fk";
  ...
  /**
   * cotacaoIntradayIndiceResultados consultas de AtivoIndice.
   *
   * @param {any} id AtivoIndice id
   *
   * @param {object} filter 
  ...
  public getCotacaoIntradayIndiceResultados(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AtivoIndices/:id/cotacaoIntradayIndiceResultados";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * cotacaoIntradayIndiceResultados contagens de AtivoIndice.
   *
   * @param {any} id AtivoIndice id
   *
  ...
  public countCotacaoIntradayIndiceResultados(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AtivoIndices/:id/cotacaoIntradayIndiceResultados/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public ListaBovespa(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AtivoIndices/listaBovespa";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaIndiceResultadoMaisRecente(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AtivoIndices/listaIndiceResultadoMaisRecente";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
