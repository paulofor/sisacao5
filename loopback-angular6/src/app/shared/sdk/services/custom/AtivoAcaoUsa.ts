...
export class AtivoAcaoUsaApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public InsereSeNaoExiste(ativo: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AtivoAcaoUsas/insereSeNaoExiste";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof ativo !== 'undefined' && ativo !== null) _urlParams.ativo = ativo;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
