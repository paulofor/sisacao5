...
/**
 * Api services for the `TradeTreinoRede` model.
 */
@Injectable()
export class TradeTreinoRedeApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id TradeTreinoRede id
   *
  ...
  public getPrevisaoRede(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/TradeTreinoRedes/:id/previsaoRede";
   ...
   * </em>
   */
  public FinalizaTrade(item: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TradeTreinoRedes/finalizaTrade";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public InsereTrade(item: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TradeTreinoRedes/insereTrade";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof item !== 'undefined' && item !== null) _urlParams.item = item;
   ...
   * </em>
   */
  public AtualizaTrade(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TradeTreinoRedes/atualizaTrade";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
