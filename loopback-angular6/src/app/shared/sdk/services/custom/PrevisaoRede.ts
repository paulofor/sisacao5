...
export class PrevisaoRedeApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public LimpaDiaTreino(diaNumPrevisao: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PrevisaoRedes/limpaDiaTreino";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof diaNumPrevisao !== 'undefined' && diaNumPrevisao !== null) _urlParams.diaNumPrevisao = diaNumPrevisao;
   ...
   * </em>
   */
  public ObtemPorTreinoDiaAnterior(treinoRedeId: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PrevisaoRedes/obtemPorTreinoDiaAnterior";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof treinoRedeId !== 'undefined' && treinoRedeId !== null) _urlParams.treinoRedeId = treinoRedeId;
   ...
   * </em>
   */
  public PrevisaoHistorico(dias: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PrevisaoRedes/previsaoHistorico";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof dias !== 'undefined' && dias !== null) _urlParams.dias = dias;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
