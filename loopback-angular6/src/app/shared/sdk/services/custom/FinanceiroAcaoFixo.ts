...
/**
 * Api services for the `FinanceiroAcaoFixo` model.
 */
@Injectable()
export class FinanceiroAcaoFixoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id FinanceiroAcaoFixo id
   *
   ...
   * This usually means the response is a `FinanceiroAcaoFixo` object.)
   * </em>
   */
  public getInstituicaoFinanceira(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FinanceiroAcaoFixos/:id/instituicaoFinanceira";
  ...
  public getTipoAplicacao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FinanceiroAcaoFixos/:id/tipoAplicacao";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
