...
/**
 * Api services for the `ExperimentoSimulacaoPeriodo` model.
 */
@Injectable()
export class ExperimentoSimulacaoPeriodoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ExperimentoSimulacaoPeriodo id
   *
   ...
   * This usually means the response is a `ExperimentoSimulacaoPeriodo` object.)
   * </em>
   */
  public getPeriodoExperimento(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ExperimentoSimulacaoPeriodos/:id/periodoExperimento";
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PATCH";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ExperimentoSimulacaoPeriodos/:id";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
   ...
   * </em>
   */
  public AtualizaPorExperimento(idExperimento: any = {}, lista: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ExperimentoSimulacaoPeriodos/atualizaPorExperimento";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
