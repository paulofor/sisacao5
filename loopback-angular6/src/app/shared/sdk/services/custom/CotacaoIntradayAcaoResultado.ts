...
export class CotacaoIntradayAcaoResultadoApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public ListaPossiveisSaidas(entrada: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/listaPossiveisSaidas";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof entrada !== 'undefined' && entrada !== null) _urlParams.entrada = entrada;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public CriaTickerAnoPorGrupo(nomeGrupo: any = {}, ano: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/criaTickerAnoPorGrupo";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public ListaPrecoEntradaPrevisaoPorDiaB3(idRegra: any = {}, idGrupo: any = {}, diaNum: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/listaPrecoEntradaPrevisaoPorDiaB3";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idRegra !== 'undefined' && idRegra !== null) _urlParams.idRegra = idRegra;
   ...
   * </em>
   */
  public ListaPrecoEntradaPrevisaoProximoB3Atrasado(idRegra: any = {}, idGrupo: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/listaPrecoEntradaPrevisaoProximoB3Atrasado";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idRegra !== 'undefined' && idRegra !== null) _urlParams.idRegra = idRegra;
   ...
   * </em>
   */
  public ObtemCotacaoDiaAnterior(ticker: any = {}, diaNum: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/obtemCotacaoDiaAnterior";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof ticker !== 'undefined' && ticker !== null) _urlParams.ticker = ticker;
   ...
   * <em>
         ...
         * </em>
   *
   * @param {number} idFechamentoRegraDia 
   *
   * @returns {object[]} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public PendentePorFechamentoRegra(idFechamentoRegraDia: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayAcaoResultados/pendentePorFechamentoRegra";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idFechamentoRegraDia !== 'undefined' && idFechamentoRegraDia !== null) _urlParams.idFechamentoRegraDia = idFechamentoRegraDia;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
