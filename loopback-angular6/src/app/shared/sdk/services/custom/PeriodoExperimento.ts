...
/**
 * Api services for the `PeriodoExperimento` model.
 */
@Injectable()
export class PeriodoExperimentoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id PeriodoExperimento id
   *
  ...
  public findByIdExperimentoSimulacaoPeriodos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/PeriodoExperimentos/:id/experimentoSimulacaoPeriodos/:fk";
  ...
  /**
   * experimentoSimulacaoPeriodos consultas de PeriodoExperimento.
   *
   * @param {any} id PeriodoExperimento id
   *
   * @param {object} filter 
  ...
  public getExperimentoSimulacaoPeriodos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/:id/experimentoSimulacaoPeriodos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * experimentoSimulacaoPeriodos contagens de PeriodoExperimento.
   *
   * @param {any} id PeriodoExperimento id
   *
  ...
  public countExperimentoSimulacaoPeriodos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/:id/experimentoSimulacaoPeriodos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public ObtemCorrenteValidador(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/obtemCorrenteValidador";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public LigaCorrenteValidador(idPeriodo: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/ligaCorrenteValidador";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public ObtemPeriodoParaExecucao(idExperimento: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/obtemPeriodoParaExecucao";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public CalculaInicioColeta(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/calculaInicioColeta";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaComDetalhe(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PeriodoExperimentos/listaComDetalhe";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
