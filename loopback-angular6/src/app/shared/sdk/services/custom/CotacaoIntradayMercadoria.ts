...
/**
 * Api services for the `CotacaoIntradayMercadoria` model.
 */
@Injectable()
export class CotacaoIntradayMercadoriaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id CotacaoIntradayMercadoria id
   *
   * @param {object} data Request data.
   *
   ...
   * </em>
   */
  public InsereValorHorarioMercadoria(ticker: any = {}, valor: any = {}, horario: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CotacaoIntradayMercadoria/insereValorHorarioMercadoria";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
