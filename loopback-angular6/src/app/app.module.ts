...
import { RedeDesenvolvimentoComponent } from './rede-desenvolvimento/rede-desenvolvimento.component';
...
import { FinanceiroFixoAcaoComponent } from './financeiro-fixo-acao/financeiro-fixo-acao.component';
...
import { ItemDadoSinteticoVisualComponent } from './item-dado-sintetico-visual/item-dado-sintetico-visual.component';
...
@NgModule({
  declarations: [
    ...
    TipoExemploTreinoEditComponent,
    ValidadorExemploSaidaComponent,
    KerasTipoListComponent,
    KerasLayerListComponent,
    KerasLayerEditComponent,
    RegraProjecaoPorGrupoComponent,
    RegraProjecaoOrdenadaDataComponent,
    KerasLossEditComponent,
    KerasLossListComponent,
    KerasOptimizerListComponent,
    KerasOptimizerEditComponent,
    RankingTreinoRedeComponent,
    RedePerformanceListComponent,
    RedeDesenvolvimentoComponent,
    SaldoCorrenteFixoEditComponent,
    PreRedeListComponent,
    PreRedeEditComponent,
    PreRedeVersaoListComponent,
    PreRedeVersaoEditComponent,
    FinanceiroFixoAcaoComponent,
    FinanceiroFixoAcaoEditComponent,
    FinanceiroAcaoAtualComponent,
    AmostraDadoSinteticoListComponent,
    AmostraDadoSinteticoEditComponent,
    AmostraDadoSinteticoDetalheComponent,
    ItemDadoSinteticoVisualComponent,
    FechamentoRegraDiaListComponent,
    FechamentoRegraDiaEditComponent,
    CriaExperimentoPreRedeEditComponent,
    ExperimentoPreRedeTreinadaEditComponent,
    ConsultaIntradayResultadoDataComponent,
