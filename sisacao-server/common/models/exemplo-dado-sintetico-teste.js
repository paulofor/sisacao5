...
module.exports = function(Exemplodadosinteticoteste) {

    Exemplodadosinteticoteste.ListaPorAmostraParaTeste = function(idAmostra, callback) {
        const filtro = {
          'fields' : {'campoY' : true, 'campoX' : true, 'id' : true},
          'where' : {'amostraDadoSinteticoId' : idAmostra}
        }
        console.log(filtro);
        Exemplodadosinteticoteste.find(filtro,(err,result) => {
          if (err==null)
            callback(err,result);
          else
            callback(err,null);
    ...
    function shuffleArray(array) {
      ...
      Exemplodadosinteticoteste.GerarPorAmostraTeste = function(idAmostra,callback) {
          const sqlDelete = "delete from ExemploDadoSinteticoTeste where amostraDadoSinteticoId = " + idAmostra;
          //let filtro = {'include' : 'tipoExemploTreino'}
          const ds = Exemplodadosinteticoteste.dataSource;
            ...
            app.models.AmostraDadoSintetico.findById(idAmostra,(err,amostra) => {
              ...
              app.models.TipoExemploTreino.findById(amostra.tipoExemploTreinoId, (err,tipoExemplo) => {
                ...
                for (let i=1;i<=qtdeSubida;i++) {
                  ...
                  const sql = "insert into ExemploDadoSinteticoTeste (amostraDadoSinteticoId, campoXOriginal, campoY, resultado, campoX) values ( " + idAmostra + " , " +
