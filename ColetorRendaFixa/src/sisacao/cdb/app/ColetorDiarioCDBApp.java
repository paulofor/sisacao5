...
public class ColetorDiarioCDBApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Inicialiando ColetorDiarioCDBApp");
		System.out.println("Versao: 13-07-2022");
		try {
			carregaProp();
			preparaComum();
			ColetorDiarioCDBObj obj = new ColetorDiarioCDBObj();
			obj.executa();
	...
	private static void carregaProp() throws IOException {
		...
		InputStream input = new FileInputStream("ColetorCDB.config");
