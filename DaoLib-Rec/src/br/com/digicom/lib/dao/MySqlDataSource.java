...
public class MySqlDataSource implements DataFonte {
	...
	public DaoConexao criaConexao() throws DaoException {
		...
		daoConexao.setConexao(
				MySqlConnectionPool.criaConexao(this.urlConexao, this.usuario, this.senha, "com.mysql.jdbc.Driver"));
		return daoConexao;
	}
	...
	public ResultSet getListaSql(String sql, Connection conexao) throws DaoException {
		...
		try {
			...
			e.printStackTrace();
			if (conexao == null)
				throw new DaoException(e, "sem conex�o aberta");
	...
	public void executaSqlForcado(String sql, DaoConexao conexao) throws DaoException {
		try {
			executaSql(sql, conexao.getConexao());
		} catch (Exception e) {
			try {
				if (conexao.getConexao().isClosed()) {
					conexao.setConexao(MySqlConnectionPool.criaConexao(this.urlConexao, this.usuario, this.senha,
 ...
 * br.com.digicom.lib.dao.MySqlDataSource JD-Core Version: 0.6.0
 */