...
public class ColetorDiarioIndividualApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Inicialiando ColetorDiarioIndividualApp");
		System.out.println("Versao: 21-06-2022");
		try {
			carregaProp();
			preparaComum();
			ColetorDiarioIndividualObj obj = new ColetorDiarioIndividualObj();
			obj.executa();
