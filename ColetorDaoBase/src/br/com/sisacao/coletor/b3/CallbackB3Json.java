...
public class CallbackB3Json extends CallbackParseJson {
	...
	public URL getUrl() throws MalformedURLException {
		return new URL("http://cotacao.b3.com.br/mds/api/v1/instrumentQuotation/" + dados.getAtivoIndice().getTicker().toLowerCase());
	}
