...
public class DiaPregao_ObtemIntradayResultadoTickerAteFinal extends DaoBaseComum {

	public static String NOME = "DiaPregao_ObtemIntradayResultadoTickerAteFinal";
	...
	protected void executaImpl() {
		...
		this.rep.obtemIntradayResultadoTickerAteFinal(ticker, dataNumInicio, tamanhoAmostra, new ListCallback<DiaPregao>() {
