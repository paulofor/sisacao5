...
public class MesAnoMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		MesAno objeto;
		objeto = (MesAno)entrada;
		  
	  	objeto.setIdMesAno(resultadoLista.getInt(pos++));  
	  	objeto.setNomeMes(resultadoLista.getString(pos++));  
	  	objeto.setNumeroAno(resultadoLista.getInt(pos++));  
	  	objeto.setMesAnoData(resultadoLista.getString(pos++));  
	  	objeto.setNumeroMes(resultadoLista.getInt(pos++));
      	return objeto;
	}
