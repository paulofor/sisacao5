...
public class ExperimentoOpcaoCurtoPrazoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaExperimentoOpcaoCurtoPrazo();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		ExperimentoOpcaoCurtoPrazo objeto;
		objeto = (ExperimentoOpcaoCurtoPrazo)entrada;
		  
	  	objeto.setIdExperimentoOpcaoCurtoPrazo(resultadoLista.getInt(pos++));  
	  	objeto.setDescricaoExperimento(resultadoLista.getString(pos++));
      	return objeto;
	}
