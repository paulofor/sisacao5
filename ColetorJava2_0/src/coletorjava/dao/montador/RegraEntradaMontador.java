...
public class RegraEntradaMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaRegraEntrada();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		RegraEntrada objeto;
		objeto = (RegraEntrada)entrada;
		  
	  	objeto.setIdRegraEntrada(resultadoLista.getInt(pos++));  
	  	objeto.setNomeRegra(resultadoLista.getString(pos++));
      	return objeto;
	}
