...
public class TreinoRedeMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaTreinoRede();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		TreinoRede objeto;
		objeto = (TreinoRede)entrada;
		  
	  	objeto.setIdTreinoRede(resultadoLista.getInt(pos++));  
	  	objeto.setLambda(resultadoLista.getFloat(pos++));  
	  	objeto.setIteracoes(resultadoLista.getInt(pos++));  
	  	objeto.setUltimaAlteracao(resultadoLista.getString(pos++));  
	  	objeto.setIdRedePa(resultadoLista.getInt(pos++));  
	  	objeto.setIdDadoTreinoGp(resultadoLista.getInt(pos++));
      	return objeto;
	}
