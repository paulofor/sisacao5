...
public class OpcaoSisacaoSerieMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaOpcaoSisacaoSerie();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		OpcaoSisacaoSerie objeto;
		objeto = (OpcaoSisacaoSerie)entrada;
		  
	  	objeto.setIdOpcaoSisacaoSerie(resultadoLista.getInt(pos++));  
	  	objeto.setMesAno(resultadoLista.getString(pos++));  
	  	objeto.setLetra(resultadoLista.getString(pos++));  
	  	objeto.setDataVencimento(resultadoLista.getString(pos++));  
	  	objeto.setDataInicioColeta(resultadoLista.getString(pos++));  
	  	objeto.setConstruida(resultadoLista.getLogicoConvertido(pos++));  
	  	objeto.setPossuiIntraday(resultadoLista.getLogicoConvertido(pos++));
      	return objeto;
	}
