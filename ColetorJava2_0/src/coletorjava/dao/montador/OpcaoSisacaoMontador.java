...
public class OpcaoSisacaoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaOpcaoSisacao();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		OpcaoSisacao objeto;
		objeto = (OpcaoSisacao)entrada;
		  
	  	objeto.setIdOpcaoSisacao(resultadoLista.getInt(pos++));  
	  	...
	  	objeto.setIdOpcaoSisacaoSeriePa(resultadoLista.getInt(pos++));  
	  	objeto.setIdTickerDd(resultadoLista.getInt(pos++));
      	return objeto;
	}
