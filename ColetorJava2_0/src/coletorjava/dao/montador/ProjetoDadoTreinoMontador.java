...
public class ProjetoDadoTreinoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaProjetoDadoTreino();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		ProjetoDadoTreino objeto;
		objeto = (ProjetoDadoTreino)entrada;
		  
	  	objeto.setIdProjetoDadoTreino(resultadoLista.getInt(pos++));  
	  	objeto.setTarget(resultadoLista.getFloat(pos++));  
	  	objeto.setStop(resultadoLista.getFloat(pos++));  
	  	objeto.setPosicaoCompraVenda(resultadoLista.getString(pos++));  
