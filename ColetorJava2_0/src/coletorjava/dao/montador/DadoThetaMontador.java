...
public class DadoThetaMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaDadoTheta();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		DadoTheta objeto;
		objeto = (DadoTheta)entrada;
		  
	  	objeto.setIdDadoTheta(resultadoLista.getInt(pos++));  
	  	objeto.setNomeArquivo(resultadoLista.getString(pos++));  
	  	objeto.setUltimaAlteracao(resultadoLista.getString(pos++));  
	  	objeto.setIdTreinoRedeGp(resultadoLista.getInt(pos++));
      	return objeto;
	}
