...
public class TickerMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		Ticker objeto;
		objeto = (Ticker)entrada;
		  
	  	objeto.setIdTicker(resultadoLista.getInt(pos++));  
	  	objeto.setNome(resultadoLista.getString(pos++));  
	  	objeto.setEmpresa(resultadoLista.getString(pos++));  
	  	objeto.setTipoAcao(resultadoLista.getString(pos++));  
	  	objeto.setDataInicioDiario(resultadoLista.getString(pos++));  
	  	objeto.setDataMaisRecenteDiario(resultadoLista.getString(pos++));  
	  	objeto.setDataInicioColetaOpcao(resultadoLista.getString(pos++));  
	  	objeto.setDataFinalColetaOpcao(resultadoLista.getString(pos++));
      	return objeto;
	}
