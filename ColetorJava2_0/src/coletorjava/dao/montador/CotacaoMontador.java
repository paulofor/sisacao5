...
public class CotacaoMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		Cotacao objeto;
		objeto = (Cotacao)entrada;
		  
	  	objeto.setId(resultadoLista.getInt(pos++));  
	  	objeto.setNeg(resultadoLista.getInt(pos++));  
	  	objeto.setData(resultadoLista.getString(pos++));  
	  	objeto.setUlt(resultadoLista.getFloat(pos++));  
	  	objeto.setHoraReal(resultadoLista.getHoraMinuto(pos++));  
	  	objeto.setHoraNeg(resultadoLista.getHoraMinuto(pos++));
      	return objeto;
	}
