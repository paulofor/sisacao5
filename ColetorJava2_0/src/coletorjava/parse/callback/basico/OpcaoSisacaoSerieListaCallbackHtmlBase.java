...
public abstract class OpcaoSisacaoSerieListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected OpcaoSisacaoSerie corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoSerieDetalheCallbackHtmlBase esta null");
