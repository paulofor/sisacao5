...
public abstract class TreinoRedeListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em TreinoRedeDetalheCallbackHtmlBase esta null");
