...
public abstract class OpcaoSisacaoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected OpcaoSisacao corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoDetalheCallbackHtmlBase esta null");
