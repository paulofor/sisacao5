...
import coletorjava.parse.dados.basico.OpcaoSisacaoSerieDadosParseBase;
import coletorjava.modelo.OpcaoSisacaoSerie;
import coletorjava.log.ArquivoLog;


public abstract class OpcaoSisacaoSerieDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected OpcaoSisacaoSerieDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (OpcaoSisacaoSerieDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("OpcaoSisacaoSerie(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoSerieListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaOpcaoSisacao_Possui(null);
