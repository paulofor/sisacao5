...
public abstract class CotacaoProcessadaOpcaoResultadoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("CotacaoProcessadaOpcaoResultado(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
