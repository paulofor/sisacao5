...
import coletorjava.parse.dados.basico.PeriodoPregaoDadosParseBase;
import coletorjava.modelo.PeriodoPregao;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class PeriodoPregaoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PeriodoPregaoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PeriodoPregao> lista = null;
	protected PeriodoPregao corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PeriodoPregaoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PeriodoPregaoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PeriodoPregaoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
