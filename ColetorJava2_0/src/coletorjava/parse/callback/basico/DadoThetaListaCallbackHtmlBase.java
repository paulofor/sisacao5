...
public abstract class DadoThetaListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em DadoThetaDetalheCallbackHtmlBase esta null");
