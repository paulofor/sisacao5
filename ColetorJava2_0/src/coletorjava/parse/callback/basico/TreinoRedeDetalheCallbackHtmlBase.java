...
import coletorjava.parse.dados.basico.TreinoRedeDadosParseBase;
import coletorjava.modelo.TreinoRede;
import coletorjava.log.ArquivoLog;


public abstract class TreinoRedeDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected TreinoRedeDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (TreinoRedeDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("TreinoRede(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em TreinoRedeListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaDadoTheta_Resultado(null);
