...
public abstract class CotacaoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CotacaoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<Cotacao> lista = null;
	protected Cotacao corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CotacaoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
