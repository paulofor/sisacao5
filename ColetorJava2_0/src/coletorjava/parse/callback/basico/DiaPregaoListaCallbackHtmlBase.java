...
public abstract class DiaPregaoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em DiaPregaoDetalheCallbackHtmlBase esta null");
