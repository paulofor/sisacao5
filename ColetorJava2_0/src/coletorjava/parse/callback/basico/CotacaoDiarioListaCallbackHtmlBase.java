...
import coletorjava.parse.dados.basico.CotacaoDiarioDadosParseBase;
import coletorjava.modelo.CotacaoDiario;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class CotacaoDiarioListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CotacaoDiarioDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<CotacaoDiario> lista = null;
	protected CotacaoDiario corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CotacaoDiarioDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoDiarioDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoDiarioListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
