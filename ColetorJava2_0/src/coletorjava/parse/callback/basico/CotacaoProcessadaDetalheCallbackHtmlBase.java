...
public abstract class CotacaoProcessadaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("CotacaoProcessada(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
