...
public abstract class RegraEntradaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("RegraEntrada(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
