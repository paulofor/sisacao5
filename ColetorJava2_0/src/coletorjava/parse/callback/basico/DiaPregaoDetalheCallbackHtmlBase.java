...
import coletorjava.parse.dados.basico.DiaPregaoDadosParseBase;
import coletorjava.modelo.DiaPregao;
import coletorjava.log.ArquivoLog;


public abstract class DiaPregaoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected DiaPregaoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (DiaPregaoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("DiaPregao(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em DiaPregaoListaCallbackHtmlBase esta null");
		finalizaObjeto();
