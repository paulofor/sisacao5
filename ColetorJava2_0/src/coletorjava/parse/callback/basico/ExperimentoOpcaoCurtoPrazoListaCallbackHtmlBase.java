...
import coletorjava.parse.dados.basico.ExperimentoOpcaoCurtoPrazoDadosParseBase;
import coletorjava.modelo.ExperimentoOpcaoCurtoPrazo;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class ExperimentoOpcaoCurtoPrazoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected ExperimentoOpcaoCurtoPrazoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<ExperimentoOpcaoCurtoPrazo> lista = null;
	protected ExperimentoOpcaoCurtoPrazo corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ExperimentoOpcaoCurtoPrazoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ExperimentoOpcaoCurtoPrazoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ExperimentoOpcaoCurtoPrazoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
