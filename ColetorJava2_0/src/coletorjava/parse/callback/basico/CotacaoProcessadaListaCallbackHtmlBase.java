...
import coletorjava.parse.dados.basico.CotacaoProcessadaDadosParseBase;
import coletorjava.modelo.CotacaoProcessada;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class CotacaoProcessadaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CotacaoProcessadaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<CotacaoProcessada> lista = null;
	protected CotacaoProcessada corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CotacaoProcessadaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoProcessadaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoProcessadaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
