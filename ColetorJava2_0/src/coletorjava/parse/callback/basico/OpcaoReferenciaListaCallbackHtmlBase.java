...
import coletorjava.parse.dados.basico.OpcaoReferenciaDadosParseBase;
import coletorjava.modelo.OpcaoReferencia;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class OpcaoReferenciaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected OpcaoReferenciaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<OpcaoReferencia> lista = null;
	protected OpcaoReferencia corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (OpcaoReferenciaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoReferenciaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoReferenciaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
