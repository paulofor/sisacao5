...
import coletorjava.parse.dados.basico.CotacaoProcessadaOpcaoResultadoDadosParseBase;
import coletorjava.modelo.CotacaoProcessadaOpcaoResultado;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class CotacaoProcessadaOpcaoResultadoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected CotacaoProcessadaOpcaoResultado corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CotacaoProcessadaOpcaoResultadoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoProcessadaOpcaoResultadoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CotacaoProcessadaOpcaoResultadoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
