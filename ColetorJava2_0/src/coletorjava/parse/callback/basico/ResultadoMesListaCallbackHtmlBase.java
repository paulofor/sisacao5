...
public abstract class ResultadoMesListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected ResultadoMes corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ResultadoMesDetalheCallbackHtmlBase esta null");
