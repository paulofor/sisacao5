...
import coletorjava.parse.dados.basico.RegraEntradaDadosParseBase;
import coletorjava.modelo.RegraEntrada;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class RegraEntradaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected RegraEntradaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<RegraEntrada> lista = null;
	protected RegraEntrada corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (RegraEntradaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em RegraEntradaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em RegraEntradaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
