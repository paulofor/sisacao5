...
public abstract class OpcaoSisacaoGeralDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("OpcaoSisacaoGeral(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
