...
import coletorjava.parse.dados.basico.DadoTreinoDadosParseBase;
import coletorjava.modelo.DadoTreino;
import coletorjava.log.ArquivoLog;


public abstract class DadoTreinoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected DadoTreinoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (DadoTreinoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("DadoTreino(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em DadoTreinoListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaTreinoRede_Gerou(null);
