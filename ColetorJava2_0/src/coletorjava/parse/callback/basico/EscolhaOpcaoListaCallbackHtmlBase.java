...
import coletorjava.parse.dados.basico.EscolhaOpcaoDadosParseBase;
import coletorjava.modelo.EscolhaOpcao;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class EscolhaOpcaoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected EscolhaOpcaoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<EscolhaOpcao> lista = null;
	protected EscolhaOpcao corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (EscolhaOpcaoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em EscolhaOpcaoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em EscolhaOpcaoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
