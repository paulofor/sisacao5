...
import coletorjava.parse.dados.basico.TickerDadosParseBase;
import coletorjava.modelo.Ticker;
import coletorjava.log.ArquivoLog;


public abstract class TickerDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected TickerDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (TickerDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("Ticker(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em TickerListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaOpcaoSisacaoGeral_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaOpcaoSisacao_Gera(null);
 	
		this.dadosParse.getItemDetalhe().setListaEscolhaOpcao_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaProjetoDadoTreino_Gera(null);
 	
		this.dadosParse.getItemDetalhe().setListaOpcaoReferencia_Possui(null);
