...
public abstract class ProjetoDadoTreinoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected ProjetoDadoTreino corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ProjetoDadoTreinoDetalheCallbackHtmlBase esta null");
