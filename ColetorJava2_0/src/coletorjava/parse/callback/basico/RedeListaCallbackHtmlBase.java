...
public abstract class RedeListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em RedeDetalheCallbackHtmlBase esta null");
