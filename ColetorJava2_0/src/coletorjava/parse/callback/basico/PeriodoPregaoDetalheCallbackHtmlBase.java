...
public abstract class PeriodoPregaoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PeriodoPregao(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
