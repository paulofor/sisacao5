...
import coletorjava.parse.dados.basico.RedeDadosParseBase;
import coletorjava.modelo.Rede;
import coletorjava.log.ArquivoLog;


public abstract class RedeDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected RedeDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (RedeDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("Rede(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em RedeListaCallbackHtmlBase esta null");
		finalizaObjeto();
