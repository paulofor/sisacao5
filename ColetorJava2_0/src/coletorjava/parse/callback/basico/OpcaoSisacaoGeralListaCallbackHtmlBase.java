...
import coletorjava.parse.dados.basico.OpcaoSisacaoGeralDadosParseBase;
import coletorjava.modelo.OpcaoSisacaoGeral;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class OpcaoSisacaoGeralListaCallbackHtmlBase  extends CallbackParseHtml{

	protected OpcaoSisacaoGeralDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<OpcaoSisacaoGeral> lista = null;
	protected OpcaoSisacaoGeral corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (OpcaoSisacaoGeralDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoGeralDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoGeralListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
