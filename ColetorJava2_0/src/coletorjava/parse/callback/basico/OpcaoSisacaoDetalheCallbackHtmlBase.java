...
import coletorjava.parse.dados.basico.OpcaoSisacaoDadosParseBase;
import coletorjava.modelo.OpcaoSisacao;
import coletorjava.log.ArquivoLog;


public abstract class OpcaoSisacaoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected OpcaoSisacaoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (OpcaoSisacaoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("OpcaoSisacao(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em OpcaoSisacaoListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaEscolhaOpcao_Escolhida(null);
 	
		this.dadosParse.getItemDetalhe().setListaCotacaoProcessadaOpcaoResultado_EstaEm(null);
