...
public abstract class OpcaoReferenciaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("OpcaoReferencia(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
