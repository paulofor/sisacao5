...
public abstract class ProjetoDadoTreinoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected ProjetoDadoTreinoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ProjetoDadoTreinoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("ProjetoDadoTreino(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ProjetoDadoTreinoListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaDadoTreino_Gerou(null);
 	
		this.dadosParse.getItemDetalhe().setListaResultadoMes_Gerou(null);
