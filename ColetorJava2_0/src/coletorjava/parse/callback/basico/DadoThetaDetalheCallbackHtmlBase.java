...
import coletorjava.parse.dados.basico.DadoThetaDadosParseBase;
import coletorjava.modelo.DadoTheta;
import coletorjava.log.ArquivoLog;


public abstract class DadoThetaDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected DadoThetaDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (DadoThetaDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("DadoTheta(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em DadoThetaListaCallbackHtmlBase esta null");
		finalizaObjeto();
