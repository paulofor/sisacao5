...
public abstract class MesAnoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em MesAnoDetalheCallbackHtmlBase esta null");
