...
public abstract class ExperimentoOpcaoCurtoPrazoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("ExperimentoOpcaoCurtoPrazo(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
