...
public abstract class EscolhaOpcaoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("EscolhaOpcao(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
