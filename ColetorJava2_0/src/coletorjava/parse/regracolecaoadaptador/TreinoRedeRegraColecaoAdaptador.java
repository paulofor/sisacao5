...
import coletorjava.parse.callback.TreinoRedeListaCallbackHtml;
import coletorjava.parse.callback.TreinoRedeDetalheCallbackHtml;
import coletorjava.parse.dados.TreinoRedeDadosParse;
...
public abstract class TreinoRedeRegraColecaoAdaptador  {
	...
	protected TreinoRedeDadosParse dadosParse = null;
	
	public TreinoRedeRegraColecaoAdaptador() {
		exec = new ExecutadorParse();
		dadosParse = new TreinoRedeDadosParse();
	}
	...
	protected ICallbackParse criaListaCallbackHtml() {
		return new TreinoRedeListaCallbackHtml();
	}
	protected ICallbackParse criaDetalheCallbackHtml() {
		return new TreinoRedeDetalheCallbackHtml();
	}
	...
	protected void preparaDadosLista(TreinoRedeDadosParse dados) {
	}
	...
	public void atualizaDetalhe(DaoConexao conexao) throws DaoException {
		TreinoRedeDao daoFonte = DBB.getInstancia().getTreinoRedeDao(); // 
		daoFonte.setConexao(conexao);
		List<TreinoRede> lista = daoFonte.ListaCorrente();
		Iterator<TreinoRede> itLista = lista.iterator();
		while (itLista.hasNext()) {
			TreinoRede corrente = itLista.next();
	...
	public final void atualizaDetalhe(TreinoRede itemRaiz, DaoConexao conexao) throws DaoException {
	...
	protected void preparaDadosDetalhe(TreinoRedeDadosParse dados) {
	}
	public TreinoRede getItemRaiz() {
	...
	private void atualizaItens(DaoConexao conexao) throws DaoException {
		...
		ICallbackParse callback = new TreinoRedeListaCallbackHtml();
		TreinoRedeDadosParse dadosParse = new TreinoRedeDadosParse();
		dadosParse.setConexao(conexao);
