...
import coletorjava.parse.callback.OpcaoSisacaoSerieListaCallbackHtml;
import coletorjava.parse.callback.OpcaoSisacaoSerieDetalheCallbackHtml;
import coletorjava.parse.dados.OpcaoSisacaoSerieDadosParse;
...
public abstract class OpcaoSisacaoSerieRegraColecaoAdaptador  {
	...
	protected OpcaoSisacaoSerieDadosParse dadosParse = null;
	
	public OpcaoSisacaoSerieRegraColecaoAdaptador() {
		exec = new ExecutadorParse();
		dadosParse = new OpcaoSisacaoSerieDadosParse();
	}
	...
	protected ICallbackParse criaListaCallbackHtml() {
		return new OpcaoSisacaoSerieListaCallbackHtml();
	}
	protected ICallbackParse criaDetalheCallbackHtml() {
		return new OpcaoSisacaoSerieDetalheCallbackHtml();
	}
	...
	protected void preparaDadosLista(OpcaoSisacaoSerieDadosParse dados) {
	}
	...
	public void atualizaDetalhe(DaoConexao conexao) throws DaoException {
		OpcaoSisacaoSerieDao daoFonte = DBB.getInstancia().getOpcaoSisacaoSerieDao(); // 
	...
	public final void atualizaDetalhe(OpcaoSisacaoSerie itemRaiz, DaoConexao conexao) throws DaoException {
	...
	protected void preparaDadosDetalhe(OpcaoSisacaoSerieDadosParse dados) {
	}
	public OpcaoSisacaoSerie getItemRaiz() {
	...
	private void atualizaItens(DaoConexao conexao) throws DaoException {
		...
		ICallbackParse callback = new OpcaoSisacaoSerieListaCallbackHtml();
		OpcaoSisacaoSerieDadosParse dadosParse = new OpcaoSisacaoSerieDadosParse();
		dadosParse.setConexao(conexao);
