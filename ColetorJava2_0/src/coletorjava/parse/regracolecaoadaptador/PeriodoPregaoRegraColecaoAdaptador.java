...
import coletorjava.parse.callback.PeriodoPregaoListaCallbackHtml;
import coletorjava.parse.callback.PeriodoPregaoDetalheCallbackHtml;
import coletorjava.parse.dados.PeriodoPregaoDadosParse;
...
public abstract class PeriodoPregaoRegraColecaoAdaptador  {
	...
	protected PeriodoPregaoDadosParse dadosParse = null;
	
	public PeriodoPregaoRegraColecaoAdaptador() {
		exec = new ExecutadorParse();
		dadosParse = new PeriodoPregaoDadosParse();
	}
	...
	protected ICallbackParse criaListaCallbackHtml() {
		return new PeriodoPregaoListaCallbackHtml();
	}
	protected ICallbackParse criaDetalheCallbackHtml() {
		return new PeriodoPregaoDetalheCallbackHtml();
	}
	...
	protected void preparaDadosLista(PeriodoPregaoDadosParse dados) {
	}
	...
	public void atualizaDetalhe(DaoConexao conexao) throws DaoException {
		PeriodoPregaoDao daoFonte = DBB.getInstancia().getPeriodoPregaoDao(); // 
		daoFonte.setConexao(conexao);
		List<PeriodoPregao> lista = daoFonte.ListaCorrente();
		Iterator<PeriodoPregao> itLista = lista.iterator();
		while (itLista.hasNext()) {
			PeriodoPregao corrente = itLista.next();
	...
	public final void atualizaDetalhe(PeriodoPregao itemRaiz, DaoConexao conexao) throws DaoException {
	...
	protected void preparaDadosDetalhe(PeriodoPregaoDadosParse dados) {
	}
	public PeriodoPregao getItemRaiz() {
	...
	private void atualizaItens(DaoConexao conexao) throws DaoException {
		...
		ICallbackParse callback = new PeriodoPregaoListaCallbackHtml();
		PeriodoPregaoDadosParse dadosParse = new PeriodoPregaoDadosParse();
		dadosParse.setConexao(conexao);
