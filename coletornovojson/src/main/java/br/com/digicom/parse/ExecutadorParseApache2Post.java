...
public class ExecutadorParseApache2Post extends ExecutadorParseApache{
	...
	public void main() throws DaoException {
		...
		try {
			HttpPost httpget = new HttpPost(this.callbackParse.getUrl().toURI());
			StringEntity params = new StringEntity("{\"query\": \"{ pairs { id }}\",\"variables\": null } ");
