...
@Component({
  selector: 'app-fundo-imobiliario-aluguel-melhores',
  templateUrl: './fundo-imobiliario-aluguel-melhores.component.html',
  styleUrls: ['./fundo-imobiliario-aluguel-melhores.component.css']
})
export class FundoImobiliarioAluguelMelhoresComponent extends BaseListComponent {
