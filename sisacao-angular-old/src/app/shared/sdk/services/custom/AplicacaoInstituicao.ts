...
/**
 * Api services for the `AplicacaoInstituicao` model.
 */
@Injectable()
export class AplicacaoInstituicaoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AplicacaoInstituicao id
   *
   ...
   * This usually means the response is a `AplicacaoInstituicao` object.)
   * </em>
   */
  public getInstituicaoFinanceira(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AplicacaoInstituicaos/:id/instituicaoFinanceira";
